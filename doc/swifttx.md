...
This mechanism has been integrated into Bitcore-Node-EcoCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EcoCoin-Project/insight-api-ecocoin#web-socket-api](https://github.com/EcoCoin-Project/insight-api-ecocoin#web-socket-api) 
* API: [https://github.com/EcoCoin-Project/insight-api-ecocoin#swifttx-transactions](https://github.com/EcoCoin-Project/insight-api-ecocoin#swifttx-transactions) 
...
By default, the EcoCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EcoCoin Core daemon:
