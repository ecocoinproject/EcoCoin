...
In order to support loading of multiple wallets in ecocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ecocoin.cpp.
...
Changes to ecocoin.cpp
----------------------
ecocoin.cpp is the entry point into ecocoin-qt, and as such, will require some minor modifications to provide hooks for
