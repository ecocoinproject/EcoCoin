...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EcoCoin Core ecocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ecocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ecocoin transaction") + "\n" +
                               "  ecocoin-tx [options] -create [commands]   " + _("Create hex-encoded ecocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ecocoin transaction
