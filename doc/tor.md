...
Run EcoCoin behind a Tor proxy
----------------------------------
...
```
./ecocoind -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```

In a typical situation, this suffices to run behind a Tor proxy:
```
./ecocoind -proxy=127.0.0.1:9050
```

Run a EcoCoin hidden server
-------------------------------
...
HiddenServicePort 989 127.0.0.1:11324
...
your ecocoind's P2P listen port (11324 by default).
```
...
```
./ecocoind -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
...
and open port 11324 on your firewall (or use -upnp).

If you only want to use Tor to reach onion addresses, but not use it as a proxy
for normal IPv4/IPv6 communication, use:
```
./ecocoind -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -discover
```

List of known EcoCoin Tor relays
------------------------------------
```
