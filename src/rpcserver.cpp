...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EcoCoin features */
        {"ecocoin", "masternode", &masternode, true, true, false},
        {"ecocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ecocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ecocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ecocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ecocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ecocoin", "startmasternode", &startmasternode, true, true, false},
        {"ecocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ecocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ecocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ecocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ecocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ecocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ecocoin", "mnbudget", &mnbudget, true, true, false},
        {"ecocoin", "preparebudget", &preparebudget, true, true, false},
        {"ecocoin", "submitbudget", &submitbudget, true, true, false},
        {"ecocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ecocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ecocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ecocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ecocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ecocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ecocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ecocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ecocoin", "mnsync", &mnsync, true, true, false},
        {"ecocoin", "spork", &spork, true, true, false},
        {"ecocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ecocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ecocoind, or the -server option to ecocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ecocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59768/\n";
}
